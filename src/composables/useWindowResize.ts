...
export function useWindowResize() {
  ...
  const isTablet = computed(() => appWidth.value >= BREAKPOINTS.MOBILE && appWidth.value < BREAKPOINTS.TABLET);
  const isDesktop = computed(() => appWidth.value >= BREAKPOINTS.DESKTOP && appWidth.value < BREAKPOINTS.LARDE_DESCTOP);
